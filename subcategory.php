...
//subcategory
$sql = "SELECT subcategories.*, categories.name as cname FROM subcategories LEFT JOIN categories 
					...
					<?php foreach ($subcategories as $subcategory) {
					 ...
					 ?>
				  	<li class="list-group-item <?php if($sid == $subcategory_id)echo 'active' ?>">
				  		<a href="" class="text-decoration-none secondarycolor"> <?= $sname ?> </a>
				  	</li>
				  	<?php } ?>
				</ul>
			</div>	
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
						<div class="card pad15 mb-3">
						  	...
						  	<div class="card-body text-center">
								...
								<a href="javascript:void(0)" class="addtocartBtn text-decoration-none" data-id="<?= $i_id ?>"data-name="<?= $i_name ?>" data-price="<?= $i_price ?>" data-discount="<?= $i_discount ?>" data-photo="<?= $i_photo ?>">Add to Cart</a>
						  	</div>
						</div>
					</div>

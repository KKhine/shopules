	...
	<div class="container">
		...
		<div class="row mt-5">
			...
			<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
				...
				<button class="addtocartBtn text-decoration-none" data-id="1" data-name='<?= $di_name ?>' data-price='<?= $di_price ?> Ks' data-discount='<?= $di_discount ?> Ks' data-photo='<?= $di_photo ?>'>Add to Cart</button>
